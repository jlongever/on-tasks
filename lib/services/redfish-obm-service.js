...
function RedfishObmServiceFactory(
    ...
    RedfishObmService.prototype.powerOn = function() {
        if (!this.params.force) {
            return this._runAction('On');
        }
        return this._runAction('ForceOn');
    };
    
    RedfishObmService.prototype.powerOff = function() {
        if (!this.params.force) {
            return this._runAction('GracefulShutdown');
        }
        return this._runAction('ForceOff');
    };

    RedfishObmService.prototype.reboot = function() {
        if (!this.params.force) {
            return this._runAction('GracefulRestart');
        }
        return this._runAction('ForceRestart');
    };
    
    RedfishObmService.prototype.NMI = function() {
        return this._runAction('Nmi');
    };
    
    RedfishObmService.prototype.powerButton = function() {
        return this._runAction('PushPowerButton');
    };
    ...
    RedfishObmService.prototype._runAction = function (action) {
        var self = this;
        var options = {
            action:action
        };
